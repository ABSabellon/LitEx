...
import BorrowingHistoryScreen from '../screens/admin/BorrowingHistoryScreen';
import ScanBookScreen from '../screens/admin/ScanBookScreen';
import AdminScanQRScreen from '../screens/admin/AdminScanQRScreen';
import ScanSelectorScreen from '../screens/admin/ScanSelectorScreen';
...
const DashboardStack = () => (
  <Stack.Navigator>
    ...
    <Stack.Screen name="BorrowingHistory" component={BorrowingHistoryScreen} options={{ title: 'Borrowing History' }} />
  </Stack.Navigator>
);
...
const ScanStack = () => (
  <Stack.Navigator>
    ...
    <Stack.Screen name="AdminScanQR" component={AdminScanQRScreen} options={{ title: 'Scan Library QR' }} />
