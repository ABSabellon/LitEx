...
const ScanQRScreen = ({ navigation }) => {
  ...
  const handleBarcodeScanned = async ({ data }) => {
    ...
    try {
      ...
      if (bookData) {
        // Always navigate to book details screen regardless of availability
        // The book details screen will show the appropriate status and options
        navigation.navigate('ScanBookDetails', { book_id: bookData.id });
      } else {
