...
const MyBooksScreen = ({ navigation, route }) => {
  ...
  const loadBooks = async () => {
    ...
    try {
      ...
      const borrows = await getBorrowsByEmail(emailToUse);
        ...
        borrows.map(async (borrow) => {
          ...
          if (book) {
            ...
            return {
              ...
              due_date: due_date,
              returned_date: borrow.returned_date ? borrow.returned_date.toDate() : null,
            ...
            <View style={styles.datesContainer}>
              ...
              {item.returned_date && (
                <View style={styles.dateRow}>
                  ...
                  <Text style={styles.dateValue}>{formatDate(item.returned_date)}</Text>
                </View>
              )}
            </View>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.authPromptContainer}>
          ...
          <Text style={styles.authPromptText}>
            Sign in to view your books or enter your guest details to check books you've borrowed as a guest.
          </Text>
